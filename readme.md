...
** Performance is significantly impacted by a debug compilation of Godot.
2) Odin-lang
3) either run the classes_parser or download the classes package [text](https://github.com/Ferinzz/Godot_Odin_Binds/tree/main)

# Setup

Import the GDWrapper folder into your code as you would any other package.
Import the Toxin folder into your code.
Import the GD_Classes folder into your code.
