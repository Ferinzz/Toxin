...
Init_Variant_Converters :: proc "c" () {
    ...
    BoolToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Bool))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.BOOL)
    IntToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Int))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.INT)
    FloatToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: float))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.FLOAT)
    StringToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: gdstring))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.STRING)
    //StringwPlaceholderToVariant = StringToVariant
    Vec2ToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector2))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR2)
    Vec2iToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector2i))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR2I)
    Recf32ToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Rect2))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.RECT2)
    Rect2iToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Rect2i))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.RECT2I)
    Vec3ToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector3))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR3)
    Vec3iToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector3i))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR3I)
    Transform2DToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Transform2D))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.TRANSFORM2D)
    Vec4ToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector4))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR4)
    Vec4iToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Vector4i))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.VECTOR4I)
    PlaneToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Plane))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PLANE)
    QuaternionToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Quaternion))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.QUATERNION)
    AABBToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: AABB))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.AABB)
    BasisToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Basis))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.BASIS)
    Transform3dToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Transform3D))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.TRANSFORM3D)
    ProjectionToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Projection))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PROJECTION)
    ColorToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Color))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.COLOR)

    StringNameToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: StringName))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.STRING_NAME)
    NodePathToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: NodePath))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.NODE_PATH)
    RidToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: RID))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.RID)
    ObjectToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Object))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.OBJECT)
    CallableToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Callable))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.CALLABLE)
    SignalToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Signal))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.SIGNAL)

    DictionaryToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Dictionary))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.DICTIONARY)
    ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.ARRAY)
    PackedByteArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedByteArray))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_BYTE_ARRAY)
    Packedi32ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedInt32Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_INT32_ARRAY)
    Packedi64ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedInt64Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_INT64_ARRAY)
    Packedf32ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedFloat32Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_FLOAT32_ARRAY)
    Packedf64ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedFloat64Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_FLOAT64_ARRAY)
    PackedStringArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedStringArray))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_STRING_ARRAY)
    PackedVec2ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedVector2Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_VECTOR2_ARRAY)
    PackedVec3ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedVector3Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_VECTOR3_ARRAY)
    PackedColorArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedColorArray))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_COLOR_ARRAY)
    PackedVec4ArrayToVariant = cast(proc "c" (dest: ^Variant, #by_ptr source: PackedVector4Array))gdAPI.Variant_Utils.GetVariantFromTypeConstructor(.PACKED_VECTOR4_ARRAY)
}
