...
init_Transform3D_Methods :: proc(Transform3D_method_store: ^Transform3D_Methods_list) {
  ...
  Transform3D_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Transform3D_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .TRANSFORM3D, .NIL)
  Transform3D_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Transform3D_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .TRANSFORM3D, .NIL)
