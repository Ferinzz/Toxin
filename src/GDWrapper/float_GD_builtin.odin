...
init_float_Methods :: proc(float_method_store: ^float_Methods_list) {
  ...
  float_method_store.VARIANT_OP_AND_Bool = cast(type_of(float_method_store.VARIANT_OP_AND_Bool))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_AND, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_OR_Bool = cast(type_of(float_method_store.VARIANT_OP_OR_Bool))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_OR, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_XOR_Bool = cast(type_of(float_method_store.VARIANT_OP_XOR_Bool))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_XOR, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_EQUAL_Int = cast(type_of(float_method_store.VARIANT_OP_EQUAL_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_EQUAL, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_NOT_EQUAL_Int = cast(type_of(float_method_store.VARIANT_OP_NOT_EQUAL_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_NOT_EQUAL, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_LESS_Int = cast(type_of(float_method_store.VARIANT_OP_LESS_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_LESS, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_LESS_EQUAL_Int = cast(type_of(float_method_store.VARIANT_OP_LESS_EQUAL_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_LESS_EQUAL, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_GREATER_Int = cast(type_of(float_method_store.VARIANT_OP_GREATER_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_GREATER, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_GREATER_EQUAL_Int = cast(type_of(float_method_store.VARIANT_OP_GREATER_EQUAL_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_GREATER_EQUAL, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_ADD_Int = cast(type_of(float_method_store.VARIANT_OP_ADD_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_ADD, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_SUBTRACT_Int = cast(type_of(float_method_store.VARIANT_OP_SUBTRACT_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_SUBTRACT, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(float_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(float_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_POWER_Int = cast(type_of(float_method_store.VARIANT_OP_POWER_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_POWER, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_AND_Int = cast(type_of(float_method_store.VARIANT_OP_AND_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_AND, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_OR_Int = cast(type_of(float_method_store.VARIANT_OP_OR_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_OR, .FLOAT, .NIL)
  float_method_store.VARIANT_OP_XOR_Int = cast(type_of(float_method_store.VARIANT_OP_XOR_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_XOR, .FLOAT, .NIL)
