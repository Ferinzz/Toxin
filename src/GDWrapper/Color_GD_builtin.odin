...
init_Color_Methods :: proc(Color_method_store: ^Color_Methods_list) {
  ...
  Color_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Color_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .COLOR, .NIL)
  Color_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Color_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .COLOR, .NIL)
