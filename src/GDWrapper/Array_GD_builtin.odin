...
init_Array_Methods :: proc(Array_method_store: ^Array_Methods_list) {
  ...
  Array_method_store.size = Get_Builtin_Method(.ARRAY, "size", 3173160232)
  Array_method_store.is_empty = Get_Builtin_Method(.ARRAY, "is_empty", 3918633141)
  Array_method_store.clear = Get_Builtin_Method(.ARRAY, "clear", 3218959716)
  Array_method_store.hash = Get_Builtin_Method(.ARRAY, "hash", 3173160232)
  Array_method_store.assign = Get_Builtin_Method(.ARRAY, "assign", 2307260970)
  Array_method_store.get = Get_Builtin_Method(.ARRAY, "get", 708700221)
  Array_method_store.set = Get_Builtin_Method(.ARRAY, "set", 3798478031)
  Array_method_store.push_back = Get_Builtin_Method(.ARRAY, "push_back", 3316032543)
  Array_method_store.push_front = Get_Builtin_Method(.ARRAY, "push_front", 3316032543)
  Array_method_store.append = Get_Builtin_Method(.ARRAY, "append", 3316032543)
  Array_method_store.append_array = Get_Builtin_Method(.ARRAY, "append_array", 2307260970)
  Array_method_store.resize = Get_Builtin_Method(.ARRAY, "resize", 848867239)
  Array_method_store.insert = Get_Builtin_Method(.ARRAY, "insert", 3176316662)
  Array_method_store.remove_at = Get_Builtin_Method(.ARRAY, "remove_at", 2823966027)
  Array_method_store.fill = Get_Builtin_Method(.ARRAY, "fill", 3316032543)
  Array_method_store.erase = Get_Builtin_Method(.ARRAY, "erase", 3316032543)
  Array_method_store.front = Get_Builtin_Method(.ARRAY, "front", 1460142086)
  Array_method_store.back = Get_Builtin_Method(.ARRAY, "back", 1460142086)
  Array_method_store.pick_random = Get_Builtin_Method(.ARRAY, "pick_random", 1460142086)
  Array_method_store.find = Get_Builtin_Method(.ARRAY, "find", 2336346817)
  Array_method_store.find_custom = Get_Builtin_Method(.ARRAY, "find_custom", 2145562546)
  Array_method_store.rfind = Get_Builtin_Method(.ARRAY, "rfind", 2336346817)
  Array_method_store.rfind_custom = Get_Builtin_Method(.ARRAY, "rfind_custom", 2145562546)
  Array_method_store.count = Get_Builtin_Method(.ARRAY, "count", 1481661226)
  Array_method_store.has = Get_Builtin_Method(.ARRAY, "has", 3680194679)
  Array_method_store.pop_back = Get_Builtin_Method(.ARRAY, "pop_back", 1321915136)
  Array_method_store.pop_front = Get_Builtin_Method(.ARRAY, "pop_front", 1321915136)
  Array_method_store.pop_at = Get_Builtin_Method(.ARRAY, "pop_at", 3518259424)
  Array_method_store.sort = Get_Builtin_Method(.ARRAY, "sort", 3218959716)
  Array_method_store.sort_custom = Get_Builtin_Method(.ARRAY, "sort_custom", 3470848906)
  Array_method_store.shuffle = Get_Builtin_Method(.ARRAY, "shuffle", 3218959716)
  Array_method_store.bsearch = Get_Builtin_Method(.ARRAY, "bsearch", 3372222236)
  Array_method_store.bsearch_custom = Get_Builtin_Method(.ARRAY, "bsearch_custom", 161317131)
  Array_method_store.reverse = Get_Builtin_Method(.ARRAY, "reverse", 3218959716)
  Array_method_store.duplicate = Get_Builtin_Method(.ARRAY, "duplicate", 636440122)
  Array_method_store.duplicate_deep = Get_Builtin_Method(.ARRAY, "duplicate_deep", 1949240801)
  Array_method_store.slice = Get_Builtin_Method(.ARRAY, "slice", 1393718243)
  Array_method_store.filter = Get_Builtin_Method(.ARRAY, "filter", 4075186556)
  Array_method_store.gdmap = Get_Builtin_Method(.ARRAY, "gdmap", 4075186556)
  Array_method_store.reduce = Get_Builtin_Method(.ARRAY, "reduce", 4272450342)
  Array_method_store.gdany = Get_Builtin_Method(.ARRAY, "gdany", 4129521963)
  Array_method_store.all = Get_Builtin_Method(.ARRAY, "all", 4129521963)
  Array_method_store.max = Get_Builtin_Method(.ARRAY, "max", 1460142086)
  Array_method_store.min = Get_Builtin_Method(.ARRAY, "min", 1460142086)
  Array_method_store.is_typed = Get_Builtin_Method(.ARRAY, "is_typed", 3918633141)
  Array_method_store.is_same_typed = Get_Builtin_Method(.ARRAY, "is_same_typed", 2988181878)
  Array_method_store.get_typed_builtin = Get_Builtin_Method(.ARRAY, "get_typed_builtin", 3173160232)
  Array_method_store.get_typed_class_name = Get_Builtin_Method(.ARRAY, "get_typed_class_name", 1825232092)
  Array_method_store.get_typed_script = Get_Builtin_Method(.ARRAY, "get_typed_script", 1460142086)
  Array_method_store.make_read_only = Get_Builtin_Method(.ARRAY, "make_read_only", 3218959716)
  Array_method_store.is_read_only = Get_Builtin_Method(.ARRAY, "is_read_only", 3918633141)
