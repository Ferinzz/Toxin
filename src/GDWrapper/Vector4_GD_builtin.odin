...
init_Vector4_Methods :: proc(Vector4_method_store: ^Vector4_Methods_list) {
  ...
  Vector4_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Vector4_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .VECTOR4, .NIL)
  Vector4_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Vector4_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .VECTOR4, .NIL)
