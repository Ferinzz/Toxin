...
init_StringName_Methods :: proc(StringName_method_store: ^StringName_Methods_list) {
  ...
  StringName_method_store.VARIANT_OP_MODULE_Bool = cast(type_of(StringName_method_store.VARIANT_OP_MODULE_Bool))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .STRING_NAME, .NIL)
  StringName_method_store.VARIANT_OP_MODULE_Int = cast(type_of(StringName_method_store.VARIANT_OP_MODULE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .STRING_NAME, .NIL)
  ...
  StringName_method_store.VARIANT_OP_EQUAL_gdstring = cast(type_of(StringName_method_store.VARIANT_OP_EQUAL_gdstring))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_EQUAL, .STRING_NAME, .NIL)
  StringName_method_store.VARIANT_OP_NOT_EQUAL_gdstring = cast(type_of(StringName_method_store.VARIANT_OP_NOT_EQUAL_gdstring))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_NOT_EQUAL, .STRING_NAME, .NIL)
  StringName_method_store.VARIANT_OP_ADD_gdstring = cast(type_of(StringName_method_store.VARIANT_OP_ADD_gdstring))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_ADD, .STRING_NAME, .NIL)
  StringName_method_store.VARIANT_OP_MODULE_gdstring = cast(type_of(StringName_method_store.VARIANT_OP_MODULE_gdstring))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .STRING_NAME, .NIL)
  StringName_method_store.VARIANT_OP_IN_gdstring = cast(type_of(StringName_method_store.VARIANT_OP_IN_gdstring))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_IN, .STRING_NAME, .NIL)
