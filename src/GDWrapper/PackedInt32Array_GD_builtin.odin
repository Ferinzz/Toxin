...
init_PackedInt32Array_Methods :: proc(PackedInt32Array_method_store: ^PackedInt32Array_Methods_list) {
  ...
  PackedInt32Array_method_store.IndxGetter = cast(type_of(PackedInt32Array_method_store.IndxGetter))gdAPI.Variant_Utils.GetPtrIndexedGetter(.PACKED_INT32_ARRAY)
  PackedInt32Array_method_store.IndxSetter = cast(type_of(PackedInt32Array_method_store.IndxSetter))gdAPI.Variant_Utils.GetPtrIndexedSetter(.PACKED_INT32_ARRAY)
