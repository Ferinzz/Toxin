...
Transform2D_Methods_list :: struct {
    ...
    get_ptr: proc "c" (base: ^Variant) -> ^Transform2D,
...
init_Transform2D_Methods :: proc "c" (Transform2D_method_store: ^Transform2D_Methods_list) {
  ...
  Transform2D_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Transform2D_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .TRANSFORM2D, .INT)
  Transform2D_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Transform2D_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .TRANSFORM2D, .INT)
