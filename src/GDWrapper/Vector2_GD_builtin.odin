...
init_Vector2_Methods :: proc(Vector2_method_store: ^Vector2_Methods_list) {
  ...
  Vector2_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Vector2_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .VECTOR2, .NIL)
  Vector2_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Vector2_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .VECTOR2, .NIL)
