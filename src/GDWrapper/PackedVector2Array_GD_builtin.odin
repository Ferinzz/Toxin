...
init_PackedVector2Array_Methods :: proc(PackedVector2Array_method_store: ^PackedVector2Array_Methods_list) {
  ...
  PackedVector2Array_method_store.get = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "get", 2609058838)
  PackedVector2Array_method_store.set = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "set", 635767250)
  PackedVector2Array_method_store.size = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "size", 3173160232)
  PackedVector2Array_method_store.is_empty = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "is_empty", 3918633141)
  PackedVector2Array_method_store.push_back = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "push_back", 4188891560)
  PackedVector2Array_method_store.append = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "append", 4188891560)
  PackedVector2Array_method_store.append_array = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "append_array", 3887534835)
  PackedVector2Array_method_store.remove_at = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "remove_at", 2823966027)
  PackedVector2Array_method_store.insert = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "insert", 2225629369)
  PackedVector2Array_method_store.fill = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "fill", 3790411178)
  PackedVector2Array_method_store.resize = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "resize", 848867239)
  PackedVector2Array_method_store.clear = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "clear", 3218959716)
  PackedVector2Array_method_store.has = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "has", 3190634762)
  PackedVector2Array_method_store.reverse = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "reverse", 3218959716)
  PackedVector2Array_method_store.slice = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "slice", 3864005350)
  PackedVector2Array_method_store.to_byte_array = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "to_byte_array", 247621236)
  PackedVector2Array_method_store.sort = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "sort", 3218959716)
  PackedVector2Array_method_store.bsearch = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "bsearch", 3341588170)
  PackedVector2Array_method_store.duplicate = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "duplicate", 1660374357)
  PackedVector2Array_method_store.find = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "find", 1469606149)
  PackedVector2Array_method_store.rfind = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "rfind", 1469606149)
  PackedVector2Array_method_store.count = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "count", 2798848307)
  PackedVector2Array_method_store.erase = Get_Builtin_Method(.PACKED_VECTOR2_ARRAY, "erase", 4188891560)
