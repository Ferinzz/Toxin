...
init_Vector3i_Methods :: proc(Vector3i_method_store: ^Vector3i_Methods_list) {
  ...
  Vector3i_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Vector3i_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .VECTOR3I, .NIL)
  Vector3i_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Vector3i_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .VECTOR3I, .NIL)
  Vector3i_method_store.VARIANT_OP_MODULE_Int = cast(type_of(Vector3i_method_store.VARIANT_OP_MODULE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .VECTOR3I, .NIL)
