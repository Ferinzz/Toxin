...
init_Vector2i_Methods :: proc(Vector2i_method_store: ^Vector2i_Methods_list) {
  ...
  Vector2i_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Vector2i_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .VECTOR2I, .NIL)
  Vector2i_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Vector2i_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .VECTOR2I, .NIL)
  Vector2i_method_store.VARIANT_OP_MODULE_Int = cast(type_of(Vector2i_method_store.VARIANT_OP_MODULE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .VECTOR2I, .NIL)
