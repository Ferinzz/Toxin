...
init_Node_Virtuals_Info :: proc () {
    ...
    _physics_process.name = StringConstruct("_physics_process")
    _process.name = StringConstruct("_process")
    _input.name = StringConstruct("_input")
    _ready.name = StringConstruct("_ready")
    _enter_tree.name = StringConstruct("_enter_tree")
    _exit_tree.name = StringConstruct("_exit_tree")
    _get_accessibility_configuration_warnings.name = StringConstruct("_get_accessibility_configuration_warnings")
    _get_configuration_warnings.name = StringConstruct("_get_configuration_warnings")
    _get_focused_accessibility_element.name = StringConstruct("_get_focused_accessibility_element")
    _shortcut_input.name = StringConstruct("_shortcut_input")
    _unhandled_input.name = StringConstruct("_unhandled_input")
    _unhandled_key_input.name = StringConstruct("_unhandled_key_input")
}

init_CanvasItem_Virtuals_Info :: proc () {
    using CanvasItem_Virtuals_Info
    _draw.p_hash = 3218959716
    _draw.name = StringConstruct("_draw")
}

init_Texture2D_Virtuals_Info :: proc () {
    using Texture2D_Virtuals_Info
    _is_pixel_opaque.p_hash = 2522259332
    _is_pixel_opaque.name = StringConstruct("_is_pixel_opaque")
    
    _get_height.p_hash = 3905245786
    _get_height.name = StringConstruct("_get_height")
    
    _get_width.p_hash = 3905245786
    _draw_txt2D.p_hash = 4094143664

    _get_width.name = StringConstruct("_get_width")
    _draw_txt2D.name = StringConstruct("_draw_rect_region")
}

init_Control_Virtual_Info :: proc () {
    using Control_Virtual_Info
    _has_point.name = StringConstruct("_has_point")
    _has_point.p_hash = 556197845
    _structured_text_parser.name = StringConstruct("_structured_text_parser")
    _structured_text_parser.p_hash = 1292548940
    _get_minimum_size.name = StringConstruct("_get_minimum_size")
    _get_minimum_size.p_hash = 3341600327
    _get_tooltip.name = StringConstruct("_get_tooltip")
    _get_tooltip.p_hash = 3674420000
    _get_drag_data.name = StringConstruct("_get_drag_data")
    _get_drag_data.p_hash = 2233896889
    _can_drop_data.name = StringConstruct("_can_drop_data")
    _can_drop_data.p_hash = 2603004011
    _drop_data.name = StringConstruct("_drop_data")
    _drop_data.p_hash = 3699746064
    _make_custom_tooltip.name = StringConstruct("_make_custom_tooltip")
    _make_custom_tooltip.p_hash = 1976279298
    _accessibility_get_contextual_info.name = StringConstruct("_accessibility_get_contextual_info")
    _accessibility_get_contextual_info.p_hash = 201670096
    _get_accessibility_container_name.name = StringConstruct("_get_accessibility_container_name")
    _get_accessibility_container_name.p_hash = 2174079723
    _gui_input.name = StringConstruct("_gui_input")
...
init_RenderDataExtension_Virtual_Info :: proc () {
    ...
    _get_render_scene_buffers.name = StringConstruct("_get_render_scene_buffers")
    
    _get_render_scene_data.p_hash = 1288715698
    _get_render_scene_data.name = StringConstruct("_get_render_scene_data")
    
    _get_environment.p_hash = 2944877500
    _get_environment.name = StringConstruct("_get_environment")

    _get_camera_attributes.p_hash = 2944877500
    _get_camera_attributes.name = StringConstruct("_get_camera_attributes")
}

init_CompositorEffect_Virtual_Info :: proc () {
    using CompositorEffect_Virtual_Info
    _render_callback.p_hash = 2153422729
    _render_callback.name = StringConstruct("_render_callback")
}
...
init_AudioStreamPlayback_Virtual_Info :: proc () {
    ...
    _start.name = StringConstruct("_start")
    _stop.name = StringConstruct("_stop")
    _is_playing.name = StringConstruct("_is_playing")
    _get_loop_count.name = StringConstruct("_get_loop_count")
    _get_playback_position.name = StringConstruct("_get_playback_position")
    _seek.name = StringConstruct("_seek")
    _mix.name = StringConstruct("_mix")
    _tag_used_streams.name = StringConstruct("_tag_used_streams")
    _set_parameter.name = StringConstruct("_set_parameter")
    _get_parameter.name = StringConstruct("_get_parameter")
}
...
init_AudioStream_Virtual_Info :: proc () {
    ...
    _instantiate_playback.name = StringConstruct("_instantiate_playback")
    _get_stream_name.name = StringConstruct("_get_stream_name")
    _get_length.name = StringConstruct("_get_length")
    _is_monophonic.name = StringConstruct("_is_monophonic")
    _get_bpm.name = StringConstruct("_get_bpm")
    _get_beat_count.name = StringConstruct("_get_beat_count")
    _get_tags.name = StringConstruct("_get_tags")
    _get_parameter_list.name = StringConstruct("_get_parameter_list")
    _has_loop.name = StringConstruct("_has_loop")
    _get_bar_beats.name = StringConstruct("_get_bar_beats")
}
...
init_CollisionObject2D_Virtual_Info :: proc () {
    ...
    _input_event.name = StringConstruct("_input_event")
    _mouse_enter.name = StringConstruct("_mouse_enter")
    _mouse_exit.name = StringConstruct("_mouse_exit")
    _mouse_shape_enter.name = StringConstruct("_mouse_shape_enter")
    _mouse_shape_exit.name = StringConstruct("_mouse_shape_exit")
}
