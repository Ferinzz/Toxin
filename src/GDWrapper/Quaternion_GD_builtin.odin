...
init_Quaternion_Methods :: proc(Quaternion_method_store: ^Quaternion_Methods_list) {
  ...
  Quaternion_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Quaternion_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .QUATERNION, .NIL)
  Quaternion_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Quaternion_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .QUATERNION, .NIL)
