...
init_PackedStringArray_Methods :: proc(PackedStringArray_method_store: ^PackedStringArray_Methods_list) {
  ...
  PackedStringArray_method_store.get = Get_Builtin_Method(.PACKED_STRING_ARRAY, "get", 2162347432)
  PackedStringArray_method_store.set = Get_Builtin_Method(.PACKED_STRING_ARRAY, "set", 725585539)
  PackedStringArray_method_store.size = Get_Builtin_Method(.PACKED_STRING_ARRAY, "size", 3173160232)
  PackedStringArray_method_store.is_empty = Get_Builtin_Method(.PACKED_STRING_ARRAY, "is_empty", 3918633141)
  PackedStringArray_method_store.push_back = Get_Builtin_Method(.PACKED_STRING_ARRAY, "push_back", 816187996)
  PackedStringArray_method_store.append = Get_Builtin_Method(.PACKED_STRING_ARRAY, "append", 816187996)
  PackedStringArray_method_store.append_array = Get_Builtin_Method(.PACKED_STRING_ARRAY, "append_array", 1120103966)
  PackedStringArray_method_store.remove_at = Get_Builtin_Method(.PACKED_STRING_ARRAY, "remove_at", 2823966027)
  PackedStringArray_method_store.insert = Get_Builtin_Method(.PACKED_STRING_ARRAY, "insert", 2432393153)
  PackedStringArray_method_store.fill = Get_Builtin_Method(.PACKED_STRING_ARRAY, "fill", 3174917410)
  PackedStringArray_method_store.resize = Get_Builtin_Method(.PACKED_STRING_ARRAY, "resize", 848867239)
  PackedStringArray_method_store.clear = Get_Builtin_Method(.PACKED_STRING_ARRAY, "clear", 3218959716)
  PackedStringArray_method_store.has = Get_Builtin_Method(.PACKED_STRING_ARRAY, "has", 2566493496)
  PackedStringArray_method_store.reverse = Get_Builtin_Method(.PACKED_STRING_ARRAY, "reverse", 3218959716)
  PackedStringArray_method_store.slice = Get_Builtin_Method(.PACKED_STRING_ARRAY, "slice", 2094601407)
  PackedStringArray_method_store.to_byte_array = Get_Builtin_Method(.PACKED_STRING_ARRAY, "to_byte_array", 247621236)
  PackedStringArray_method_store.sort = Get_Builtin_Method(.PACKED_STRING_ARRAY, "sort", 3218959716)
  PackedStringArray_method_store.bsearch = Get_Builtin_Method(.PACKED_STRING_ARRAY, "bsearch", 1171495151)
  PackedStringArray_method_store.duplicate = Get_Builtin_Method(.PACKED_STRING_ARRAY, "duplicate", 747180633)
  PackedStringArray_method_store.find = Get_Builtin_Method(.PACKED_STRING_ARRAY, "find", 1760645412)
  PackedStringArray_method_store.rfind = Get_Builtin_Method(.PACKED_STRING_ARRAY, "rfind", 1760645412)
  PackedStringArray_method_store.count = Get_Builtin_Method(.PACKED_STRING_ARRAY, "count", 2920860731)
  PackedStringArray_method_store.erase = Get_Builtin_Method(.PACKED_STRING_ARRAY, "erase", 816187996)
