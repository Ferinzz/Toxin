...
init_PackedFloat64Array_Methods :: proc(PackedFloat64Array_method_store: ^PackedFloat64Array_Methods_list) {
  ...
  PackedFloat64Array_method_store.get = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "get", 1401583798)
  PackedFloat64Array_method_store.set = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "set", 1113000516)
  PackedFloat64Array_method_store.size = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "size", 3173160232)
  PackedFloat64Array_method_store.is_empty = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "is_empty", 3918633141)
  PackedFloat64Array_method_store.push_back = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "push_back", 4094791666)
  PackedFloat64Array_method_store.append = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "append", 4094791666)
  PackedFloat64Array_method_store.append_array = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "append_array", 792078629)
  PackedFloat64Array_method_store.remove_at = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "remove_at", 2823966027)
  PackedFloat64Array_method_store.insert = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "insert", 1379903876)
  PackedFloat64Array_method_store.fill = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "fill", 833936903)
  PackedFloat64Array_method_store.resize = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "resize", 848867239)
  PackedFloat64Array_method_store.clear = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "clear", 3218959716)
  PackedFloat64Array_method_store.has = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "has", 1296369134)
  PackedFloat64Array_method_store.reverse = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "reverse", 3218959716)
  PackedFloat64Array_method_store.slice = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "slice", 2192974324)
  PackedFloat64Array_method_store.to_byte_array = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "to_byte_array", 247621236)
  PackedFloat64Array_method_store.sort = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "sort", 3218959716)
  PackedFloat64Array_method_store.bsearch = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "bsearch", 1175118842)
  PackedFloat64Array_method_store.duplicate = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "duplicate", 1627308337)
  PackedFloat64Array_method_store.find = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "find", 1343150241)
  PackedFloat64Array_method_store.rfind = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "rfind", 1343150241)
  PackedFloat64Array_method_store.count = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "count", 2859915090)
  PackedFloat64Array_method_store.erase = Get_Builtin_Method(.PACKED_FLOAT64_ARRAY, "erase", 4094791666)
