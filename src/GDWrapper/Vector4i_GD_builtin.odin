...
init_Vector4i_Methods :: proc(Vector4i_method_store: ^Vector4i_Methods_list) {
  ...
  Vector4i_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Vector4i_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .VECTOR4I, .NIL)
  Vector4i_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Vector4i_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .VECTOR4I, .NIL)
  Vector4i_method_store.VARIANT_OP_MODULE_Int = cast(type_of(Vector4i_method_store.VARIANT_OP_MODULE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MODULE, .VECTOR4I, .NIL)
