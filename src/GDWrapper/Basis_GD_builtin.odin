...
init_Basis_Methods :: proc(Basis_method_store: ^Basis_Methods_list) {
  ...
  Basis_method_store.VARIANT_OP_MULTIPLY_Int = cast(type_of(Basis_method_store.VARIANT_OP_MULTIPLY_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_MULTIPLY, .BASIS, .NIL)
  Basis_method_store.VARIANT_OP_DIVIDE_Int = cast(type_of(Basis_method_store.VARIANT_OP_DIVIDE_Int))gdAPI.Variant_Utils.GetPtrOperatorEvaluator(.VARIANT_OP_DIVIDE, .BASIS, .NIL)
