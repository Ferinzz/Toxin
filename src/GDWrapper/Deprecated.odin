...
/*
callDeferred :: proc "c" (Object: ^Object, method: ^StringName, r_Variant: ^GDE.Variant) {
...
ObjectToString :: proc "c" (Object: ^Object, r_String: ^gdstring) {
...
isAnythingPressed :: proc "c" (r_bool: ^Bool) {
...
isKeyPressed :: proc "c" (keycode: ^Key, r_bool: ^Bool) {
...
isPhysicalKeyPressed :: proc "c" (keycode: ^Key, r_bool: ^Bool) {
...
isLabelKeyPressed :: proc "c" (keycode: ^Key, r_bool: ^Bool) {
...
isMouseButtonPressed :: proc "c" (button: ^MouseButton, r_bool: ^Bool) {
...
getLastMouseVelocity :: proc "c" (r_v2Pos: ^Vector2) {
...
getLastMouseScreenVelocity :: proc "c" (r_v2Pos: ^Vector2) {
...
getMouseButtonMask :: proc "c" (r_mouseMask: ^MouseButtonMask) {
    @(static)GetLastMouseScreenVelocity: GDE.MethodBindPtr
...
setMouseMode :: proc "c" (mouseMode: ^MouseMode) {
...
getMouseMode :: proc "c" (r_mouseMode: ^MouseMode) {
...
isActionPressed :: proc "c" (action: ^StringName, exact_match: ^Bool, r_bool: ^Bool) {
...
isActionJustPressed :: proc "c" (action: ^StringName, exact_match: ^Bool, r_bool: ^Bool) {
...
isActionJustReleased :: proc "c" (action: ^StringName, exact_match: ^Bool, r_bool: ^Bool) {
...
getActionStrength :: proc "c" (action: ^StringName, exact_match: ^Bool, r_bool: ^float) {
...
getActionRawStrength :: proc "c" (action: ^StringName, exact_match: ^Bool, r_bool: ^float) {
...
//Strength default 1
actionPress :: proc "c" (action: ^StringName, strength: ^float) {
...
actionRelease :: proc "c" (action: ^StringName) {
...
warpMouse :: proc "c" (position: ^Vector2) {
...
setDefaultCursorShape :: proc "c" (cursorShape: ^CursorShape) {
...
getCurrentCursorShape :: proc "c" (r_cursorShape: ^CursorShape) {
...
setCustomMouseCursor :: proc "c" (image: ^^Object, shape: ^CursorShape, hotspot: ^Vector2) {
...
parseInputEvent :: proc "c" (event: ^^Object) {
...
setUseAccumulatedInput :: proc "c" (enable: ^Bool) {
...
isUsingAccumulatedInput :: proc "c" (r_enable: ^Bool) {
...
queueRedraw :: proc "c" (object: ^Object) {
...
drawTexture2D :: proc "c" (object: ^Object, image: ^^Object, position: ^Vector2, color: ^Color) {
...
getWorld2D :: proc "c" (viewport: GDE.TypePtr, r_world: ^GDE.TypePtr) {
...
getViewpRect :: proc "c" (object: ^Object, r_rect: ^Rect2) {
...
setTexture :: proc "c" (dest: ^Object, texture: ^^Object) {    
...
getSizeTexture2D :: proc "c" (object: ^Object, r_size: ^Vector2) {
...
getViewport :: proc "c" (object: ^Object, r_viewport: ^^Object) {
...
getRenderServer2dObj :: proc "c" () -> ^Object {
...
*/
freeRenderRID :: proc "c" (resourceId: ^RID, renderServer: ^Object = RenderServerObj) {
...
getAlloweredSizeFlagsHorizontal :: proc "c" (container: ^Object, r_sizeFlags: ^PackedInt32Array) {
...
getAlloweredSizeFlagsVertical :: proc "c" (container: ^Object, r_sizeFlags: ^PackedInt32Array) {
...
queueSort :: proc "c" (container: ^Object) {
...
fitChildInRect :: proc "c" (container: ^Object, child: ^^Object, rect: ^Rect2) {
...
getSpace :: proc "c" (world2d: GDE.TypePtr, r_space: ^GDE.TypePtr) {
...
bodySetSpace :: proc "c" (body: ^RID, space: ^GDE.TypePtr, physServer := PhysServer2dObj) {
...
bodyAddShape :: proc "c" (body: ^RID, shape: ^RID, trans2d: Transform2D = {1,0,0,1,0,0}, disabled: ^Bool, physServer := PhysServer2dObj){
...
/*
shapeSetData :: proc "c" (shape: ^RID, data: ^Int, physServer := PhysServer2dObj){
...
bodyCreate :: proc "c" (r_body: ^RID, physServer := PhysServer2dObj) {
...
*/
bodySetCollisionMask :: proc "c" (body: ^RID, mask: ^u32, physServer:= PhysServer2dObj) {
...
bodySetState :: proc "c" (body: ^RID, bodyState: ^BodyState, trans_v: ^GDE.Variant, physServer:= PhysServer2dObj) {
