...
Reference :: proc(ref: ^Object, r_bool: ^Bool) {
    gdAPI.Object_Utils.MethodBindPtrcall(RefCounted_Methods_list.reference, ref, nil, r_bool)
}

Unreference :: proc(ref: ^Object, r_bool: ^Bool) {
    gdAPI.Object_Utils.MethodBindPtrcall(RefCounted_Methods_list.unreference, ref, nil, r_bool)
}

Reference_init :: proc(ref: ^Object, r_bool: ^Bool) {
    gdAPI.Object_Utils.MethodBindPtrcall(RefCounted_Methods_list.init_ref, ref, nil, r_bool)
}
