 ...
 * @param r_return A pointer a Variant which will be assigned the return value.
 * @param r_valid A pointer to a b8ean which will be set to false if the operation is invalid.
 *
 ...
 * @param p_value A pointer to a Variant representing the value.
 * @param r_valid A pointer to a b8ean which will be set to false if the operation is invalid.
 * @param r_oob A pointer to a b8ean which will be set to true if the index is out of bounds.
 */
...
/**
 * @name variant_b8eanize
 * @since 4.1
 *
 * Converts a Variant to a b8ean.
 *
 * @param p_self A pointer to the Variant.
 *
 * @return The b8ean value of the Variant.
 */
 ...
 * @param p_self A pointer to the Variant.
 * @param p_key A pointer to a Variant representing the key.
 * @param r_valid A pointer to a b8ean which will be set to false if the key doesn't exist.
 *
