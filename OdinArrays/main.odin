...
extensionInit :: proc "c" (userdata: rawptr, initLevel: GDE.InitializationLevel) {
    ...
    */
    ...
    OdinArrayBindMethod(OdinRect2Array, OdinRect2Array_CString, &OdinRect2Array_SN, &OdinRect2Arrayprocs, Class_String)
    OdinArrayBindMethod(OdinRect2iArray, OdinRect2iArray_CString, &OdinRect2iArray_SN, &OdinRect2iArrayprocs, Class_String)
    ...
    OdinArrayNoRefBindMethod(OdinRect2ArrayNoRef, OdinRect2ArrayNoRef_CString, &OdinRect2ArrayNoRef_SN,                    &OdinRect2ArrayNoRefprocs, Class_StringNoRef)
    OdinArrayNoRefBindMethod(OdinRect2iArrayNoRef, OdinRect2iArrayNoRef_CString, &OdinRect2iArrayNoRef_SN,                 &OdinRect2iArrayNoRefprocs, Class_StringNoRef)
