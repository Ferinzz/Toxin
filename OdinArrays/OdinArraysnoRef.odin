...
OdinArrayNoRefBindMethod :: proc "c" ($classStruct: typeid, $className: cstring, className_SN: ^GDE.StringName, arrayProcs: ^$T/ArrayProcs, Class_String: cstring, loc:=#caller_location, ctx:=GDW.godotContext){
    context = ctx
