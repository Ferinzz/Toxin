...
Orientation :: enum i64 {
  VERTICAL = 1,
  HORIZONTAL = 0,
}

ClockDirection :: enum i64 {
  CLOCKWISE = 0,
  COUNTERCLOCKWISE = 1,
}

HorizontalAlignment :: enum i64 {
...
KeyModifierMask_Flags :: bit_set [KeyModifierMask; i64]
KeyModifierMask :: enum i64 {
  KEY_CODE_MASK,
  KEY_MODIFIER_MASK,
...
MouseButtonMask_Flags :: bit_set [MouseButtonMask; i64]
