...
init_Callable_Methods :: proc(Callable_method_store: ^Callable_Methods_list) {
  ...
  Callable_method_store.create = GDW.Get_Builtin_Method(.CALLABLE, "create", 1709381114)
  Callable_method_store.callv = GDW.Get_Builtin_Method(.CALLABLE, "callv", 413578926)
  Callable_method_store.is_null = GDW.Get_Builtin_Method(.CALLABLE, "is_null", 3918633141)
  Callable_method_store.is_custom = GDW.Get_Builtin_Method(.CALLABLE, "is_custom", 3918633141)
  Callable_method_store.is_standard = GDW.Get_Builtin_Method(.CALLABLE, "is_standard", 3918633141)
  Callable_method_store.is_valid = GDW.Get_Builtin_Method(.CALLABLE, "is_valid", 3918633141)
  Callable_method_store.get_object = GDW.Get_Builtin_Method(.CALLABLE, "get_object", 4008621732)
  Callable_method_store.get_object_id = GDW.Get_Builtin_Method(.CALLABLE, "get_object_id", 3173160232)
  Callable_method_store.get_method = GDW.Get_Builtin_Method(.CALLABLE, "get_method", 1825232092)
  Callable_method_store.get_argument_count = GDW.Get_Builtin_Method(.CALLABLE, "get_argument_count", 3173160232)
  Callable_method_store.get_bound_arguments_count = GDW.Get_Builtin_Method(.CALLABLE, "get_bound_arguments_count", 3173160232)
  Callable_method_store.get_bound_arguments = GDW.Get_Builtin_Method(.CALLABLE, "get_bound_arguments", 4144163970)
  Callable_method_store.get_unbound_arguments_count = GDW.Get_Builtin_Method(.CALLABLE, "get_unbound_arguments_count", 3173160232)
  Callable_method_store.hash = GDW.Get_Builtin_Method(.CALLABLE, "hash", 3173160232)
  Callable_method_store.bindv = GDW.Get_Builtin_Method(.CALLABLE, "bindv", 3564560322)
  Callable_method_store.unbind = GDW.Get_Builtin_Method(.CALLABLE, "unbind", 755001590)
  Callable_method_store.call = GDW.Get_Builtin_Method(.CALLABLE, "call", 3643564216)
  Callable_method_store.call_deferred = GDW.Get_Builtin_Method(.CALLABLE, "call_deferred", 3286317445)
  Callable_method_store.rpc = GDW.Get_Builtin_Method(.CALLABLE, "rpc", 3286317445)
  Callable_method_store.rpc_id = GDW.Get_Builtin_Method(.CALLABLE, "rpc_id", 2270047679)
  Callable_method_store.bind = GDW.Get_Builtin_Method(.CALLABLE, "bind", 3224143119)
