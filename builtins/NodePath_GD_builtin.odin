...
init_NodePath_Methods :: proc(NodePath_method_store: ^NodePath_Methods_list) {
  ...
  NodePath_method_store.is_absolute = GDW.Get_Builtin_Method(.NODE_PATH, "is_absolute", 3918633141)
  NodePath_method_store.get_name_count = GDW.Get_Builtin_Method(.NODE_PATH, "get_name_count", 3173160232)
  NodePath_method_store.get_name = GDW.Get_Builtin_Method(.NODE_PATH, "get_name", 2948586938)
  NodePath_method_store.get_subname_count = GDW.Get_Builtin_Method(.NODE_PATH, "get_subname_count", 3173160232)
  NodePath_method_store.hash = GDW.Get_Builtin_Method(.NODE_PATH, "hash", 3173160232)
  NodePath_method_store.get_subname = GDW.Get_Builtin_Method(.NODE_PATH, "get_subname", 2948586938)
  NodePath_method_store.get_concatenated_names = GDW.Get_Builtin_Method(.NODE_PATH, "get_concatenated_names", 1825232092)
  NodePath_method_store.get_concatenated_subnames = GDW.Get_Builtin_Method(.NODE_PATH, "get_concatenated_subnames", 1825232092)
  NodePath_method_store.slice = GDW.Get_Builtin_Method(.NODE_PATH, "slice", 421628484)
  NodePath_method_store.get_as_property_path = GDW.Get_Builtin_Method(.NODE_PATH, "get_as_property_path", 1598598043)
  NodePath_method_store.is_empty = GDW.Get_Builtin_Method(.NODE_PATH, "is_empty", 3918633141)
