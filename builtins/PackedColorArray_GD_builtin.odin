...
init_PackedColorArray_Methods :: proc(PackedColorArray_method_store: ^PackedColorArray_Methods_list) {
  ...
  PackedColorArray_method_store.get = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "get", 2972831132)
  PackedColorArray_method_store.set = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "set", 1444096570)
  PackedColorArray_method_store.size = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "size", 3173160232)
  PackedColorArray_method_store.is_empty = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "is_empty", 3918633141)
  PackedColorArray_method_store.push_back = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "push_back", 1007858200)
  PackedColorArray_method_store.append = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "append", 1007858200)
  PackedColorArray_method_store.append_array = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "append_array", 798822497)
  PackedColorArray_method_store.remove_at = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "remove_at", 2823966027)
  PackedColorArray_method_store.insert = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "insert", 785289703)
  PackedColorArray_method_store.fill = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "fill", 3730314301)
  PackedColorArray_method_store.resize = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "resize", 848867239)
  PackedColorArray_method_store.clear = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "clear", 3218959716)
  PackedColorArray_method_store.has = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "has", 3167426256)
  PackedColorArray_method_store.reverse = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "reverse", 3218959716)
  PackedColorArray_method_store.slice = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "slice", 2451797139)
  PackedColorArray_method_store.to_byte_array = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "to_byte_array", 247621236)
  PackedColorArray_method_store.sort = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "sort", 3218959716)
  PackedColorArray_method_store.bsearch = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "bsearch", 2639732838)
  PackedColorArray_method_store.duplicate = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "duplicate", 3072026941)
  PackedColorArray_method_store.find = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "find", 3156095363)
  PackedColorArray_method_store.rfind = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "rfind", 3156095363)
  PackedColorArray_method_store.count = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "count", 1682108616)
  PackedColorArray_method_store.erase = GDW.Get_Builtin_Method(.PACKED_COLOR_ARRAY, "erase", 1007858200)
