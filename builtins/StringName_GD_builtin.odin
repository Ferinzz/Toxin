...
init_StringName_Methods :: proc(StringName_method_store: ^StringName_Methods_list) {
  ...
  StringName_method_store.casecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "casecmp_to", 2920860731)
  StringName_method_store.nocasecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "nocasecmp_to", 2920860731)
  StringName_method_store.naturalcasecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "naturalcasecmp_to", 2920860731)
  StringName_method_store.naturalnocasecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "naturalnocasecmp_to", 2920860731)
  StringName_method_store.filecasecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "filecasecmp_to", 2920860731)
  StringName_method_store.filenocasecmp_to = GDW.Get_Builtin_Method(.STRING_NAME, "filenocasecmp_to", 2920860731)
  StringName_method_store.length = GDW.Get_Builtin_Method(.STRING_NAME, "length", 3173160232)
  StringName_method_store.substr = GDW.Get_Builtin_Method(.STRING_NAME, "substr", 787537301)
  StringName_method_store.get_slice = GDW.Get_Builtin_Method(.STRING_NAME, "get_slice", 3535100402)
  StringName_method_store.get_slicec = GDW.Get_Builtin_Method(.STRING_NAME, "get_slicec", 787537301)
  StringName_method_store.get_slice_count = GDW.Get_Builtin_Method(.STRING_NAME, "get_slice_count", 2920860731)
  StringName_method_store.find = GDW.Get_Builtin_Method(.STRING_NAME, "find", 1760645412)
  StringName_method_store.findn = GDW.Get_Builtin_Method(.STRING_NAME, "findn", 1760645412)
  StringName_method_store.count = GDW.Get_Builtin_Method(.STRING_NAME, "count", 2343087891)
  StringName_method_store.countn = GDW.Get_Builtin_Method(.STRING_NAME, "countn", 2343087891)
  StringName_method_store.rfind = GDW.Get_Builtin_Method(.STRING_NAME, "rfind", 1760645412)
  StringName_method_store.rfindn = GDW.Get_Builtin_Method(.STRING_NAME, "rfindn", 1760645412)
  StringName_method_store.match = GDW.Get_Builtin_Method(.STRING_NAME, "match", 2566493496)
  StringName_method_store.matchn = GDW.Get_Builtin_Method(.STRING_NAME, "matchn", 2566493496)
  StringName_method_store.begins_with = GDW.Get_Builtin_Method(.STRING_NAME, "begins_with", 2566493496)
  StringName_method_store.ends_with = GDW.Get_Builtin_Method(.STRING_NAME, "ends_with", 2566493496)
  StringName_method_store.is_subsequence_of = GDW.Get_Builtin_Method(.STRING_NAME, "is_subsequence_of", 2566493496)
  StringName_method_store.is_subsequence_ofn = GDW.Get_Builtin_Method(.STRING_NAME, "is_subsequence_ofn", 2566493496)
  StringName_method_store.bigrams = GDW.Get_Builtin_Method(.STRING_NAME, "bigrams", 747180633)
  StringName_method_store.similarity = GDW.Get_Builtin_Method(.STRING_NAME, "similarity", 2697460964)
  StringName_method_store.format = GDW.Get_Builtin_Method(.STRING_NAME, "format", 3212199029)
  StringName_method_store.replace = GDW.Get_Builtin_Method(.STRING_NAME, "replace", 1340436205)
  StringName_method_store.replacen = GDW.Get_Builtin_Method(.STRING_NAME, "replacen", 1340436205)
  StringName_method_store.replace_char = GDW.Get_Builtin_Method(.STRING_NAME, "replace_char", 787537301)
  StringName_method_store.replace_chars = GDW.Get_Builtin_Method(.STRING_NAME, "replace_chars", 3535100402)
  StringName_method_store.remove_char = GDW.Get_Builtin_Method(.STRING_NAME, "remove_char", 2162347432)
  StringName_method_store.remove_chars = GDW.Get_Builtin_Method(.STRING_NAME, "remove_chars", 3134094431)
  StringName_method_store.repeat = GDW.Get_Builtin_Method(.STRING_NAME, "repeat", 2162347432)
  StringName_method_store.reverse = GDW.Get_Builtin_Method(.STRING_NAME, "reverse", 3942272618)
  StringName_method_store.insert = GDW.Get_Builtin_Method(.STRING_NAME, "insert", 248737229)
  StringName_method_store.erase = GDW.Get_Builtin_Method(.STRING_NAME, "erase", 787537301)
  StringName_method_store.capitalize = GDW.Get_Builtin_Method(.STRING_NAME, "capitalize", 3942272618)
  StringName_method_store.to_camel_case = GDW.Get_Builtin_Method(.STRING_NAME, "to_camel_case", 3942272618)
  StringName_method_store.to_pascal_case = GDW.Get_Builtin_Method(.STRING_NAME, "to_pascal_case", 3942272618)
  StringName_method_store.to_snake_case = GDW.Get_Builtin_Method(.STRING_NAME, "to_snake_case", 3942272618)
  StringName_method_store.to_kebab_case = GDW.Get_Builtin_Method(.STRING_NAME, "to_kebab_case", 3942272618)
  StringName_method_store.split = GDW.Get_Builtin_Method(.STRING_NAME, "split", 1252735785)
  StringName_method_store.rsplit = GDW.Get_Builtin_Method(.STRING_NAME, "rsplit", 1252735785)
  StringName_method_store.split_floats = GDW.Get_Builtin_Method(.STRING_NAME, "split_floats", 2092079095)
  StringName_method_store.join = GDW.Get_Builtin_Method(.STRING_NAME, "join", 3595973238)
  StringName_method_store.to_upper = GDW.Get_Builtin_Method(.STRING_NAME, "to_upper", 3942272618)
  StringName_method_store.to_lower = GDW.Get_Builtin_Method(.STRING_NAME, "to_lower", 3942272618)
  StringName_method_store.left = GDW.Get_Builtin_Method(.STRING_NAME, "left", 2162347432)
  StringName_method_store.right = GDW.Get_Builtin_Method(.STRING_NAME, "right", 2162347432)
  StringName_method_store.strip_edges = GDW.Get_Builtin_Method(.STRING_NAME, "strip_edges", 907855311)
  StringName_method_store.strip_escapes = GDW.Get_Builtin_Method(.STRING_NAME, "strip_escapes", 3942272618)
  StringName_method_store.lstrip = GDW.Get_Builtin_Method(.STRING_NAME, "lstrip", 3134094431)
  StringName_method_store.rstrip = GDW.Get_Builtin_Method(.STRING_NAME, "rstrip", 3134094431)
  StringName_method_store.get_extension = GDW.Get_Builtin_Method(.STRING_NAME, "get_extension", 3942272618)
  StringName_method_store.get_basename = GDW.Get_Builtin_Method(.STRING_NAME, "get_basename", 3942272618)
  StringName_method_store.path_join = GDW.Get_Builtin_Method(.STRING_NAME, "path_join", 3134094431)
  StringName_method_store.unicode_at = GDW.Get_Builtin_Method(.STRING_NAME, "unicode_at", 4103005248)
  StringName_method_store.indent = GDW.Get_Builtin_Method(.STRING_NAME, "indent", 3134094431)
  StringName_method_store.dedent = GDW.Get_Builtin_Method(.STRING_NAME, "dedent", 3942272618)
  StringName_method_store.md5_text = GDW.Get_Builtin_Method(.STRING_NAME, "md5_text", 3942272618)
  StringName_method_store.sha1_text = GDW.Get_Builtin_Method(.STRING_NAME, "sha1_text", 3942272618)
  StringName_method_store.sha256_text = GDW.Get_Builtin_Method(.STRING_NAME, "sha256_text", 3942272618)
  StringName_method_store.md5_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "md5_buffer", 247621236)
  StringName_method_store.sha1_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "sha1_buffer", 247621236)
  StringName_method_store.sha256_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "sha256_buffer", 247621236)
  StringName_method_store.is_empty = GDW.Get_Builtin_Method(.STRING_NAME, "is_empty", 3918633141)
  StringName_method_store.contains = GDW.Get_Builtin_Method(.STRING_NAME, "contains", 2566493496)
  StringName_method_store.containsn = GDW.Get_Builtin_Method(.STRING_NAME, "containsn", 2566493496)
  StringName_method_store.is_absolute_path = GDW.Get_Builtin_Method(.STRING_NAME, "is_absolute_path", 3918633141)
  StringName_method_store.is_relative_path = GDW.Get_Builtin_Method(.STRING_NAME, "is_relative_path", 3918633141)
  StringName_method_store.simplify_path = GDW.Get_Builtin_Method(.STRING_NAME, "simplify_path", 3942272618)
  StringName_method_store.get_base_dir = GDW.Get_Builtin_Method(.STRING_NAME, "get_base_dir", 3942272618)
  StringName_method_store.get_file = GDW.Get_Builtin_Method(.STRING_NAME, "get_file", 3942272618)
  StringName_method_store.xml_escape = GDW.Get_Builtin_Method(.STRING_NAME, "xml_escape", 3429816538)
  StringName_method_store.xml_unescape = GDW.Get_Builtin_Method(.STRING_NAME, "xml_unescape", 3942272618)
  StringName_method_store.uri_encode = GDW.Get_Builtin_Method(.STRING_NAME, "uri_encode", 3942272618)
  StringName_method_store.uri_decode = GDW.Get_Builtin_Method(.STRING_NAME, "uri_decode", 3942272618)
  StringName_method_store.uri_file_decode = GDW.Get_Builtin_Method(.STRING_NAME, "uri_file_decode", 3942272618)
  StringName_method_store.c_escape = GDW.Get_Builtin_Method(.STRING_NAME, "c_escape", 3942272618)
  StringName_method_store.c_unescape = GDW.Get_Builtin_Method(.STRING_NAME, "c_unescape", 3942272618)
  StringName_method_store.json_escape = GDW.Get_Builtin_Method(.STRING_NAME, "json_escape", 3942272618)
  StringName_method_store.validate_node_name = GDW.Get_Builtin_Method(.STRING_NAME, "validate_node_name", 3942272618)
  StringName_method_store.validate_filename = GDW.Get_Builtin_Method(.STRING_NAME, "validate_filename", 3942272618)
  StringName_method_store.is_valid_ascii_identifier = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_ascii_identifier", 3918633141)
  StringName_method_store.is_valid_unicode_identifier = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_unicode_identifier", 3918633141)
  StringName_method_store.is_valid_identifier = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_identifier", 3918633141)
  StringName_method_store.is_valid_int = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_int", 3918633141)
  StringName_method_store.is_valid_float = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_float", 3918633141)
  StringName_method_store.is_valid_hex_number = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_hex_number", 593672999)
  StringName_method_store.is_valid_html_color = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_html_color", 3918633141)
  StringName_method_store.is_valid_ip_address = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_ip_address", 3918633141)
  StringName_method_store.is_valid_filename = GDW.Get_Builtin_Method(.STRING_NAME, "is_valid_filename", 3918633141)
  StringName_method_store.to_int = GDW.Get_Builtin_Method(.STRING_NAME, "to_int", 3173160232)
  StringName_method_store.to_float = GDW.Get_Builtin_Method(.STRING_NAME, "to_float", 466405837)
  StringName_method_store.hex_to_int = GDW.Get_Builtin_Method(.STRING_NAME, "hex_to_int", 3173160232)
  StringName_method_store.bin_to_int = GDW.Get_Builtin_Method(.STRING_NAME, "bin_to_int", 3173160232)
  StringName_method_store.lpad = GDW.Get_Builtin_Method(.STRING_NAME, "lpad", 248737229)
  StringName_method_store.rpad = GDW.Get_Builtin_Method(.STRING_NAME, "rpad", 248737229)
  StringName_method_store.pad_decimals = GDW.Get_Builtin_Method(.STRING_NAME, "pad_decimals", 2162347432)
  StringName_method_store.pad_zeros = GDW.Get_Builtin_Method(.STRING_NAME, "pad_zeros", 2162347432)
  StringName_method_store.trim_prefix = GDW.Get_Builtin_Method(.STRING_NAME, "trim_prefix", 3134094431)
  StringName_method_store.trim_suffix = GDW.Get_Builtin_Method(.STRING_NAME, "trim_suffix", 3134094431)
  StringName_method_store.to_ascii_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_ascii_buffer", 247621236)
  StringName_method_store.to_utf8_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_utf8_buffer", 247621236)
  StringName_method_store.to_utf16_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_utf16_buffer", 247621236)
  StringName_method_store.to_utf32_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_utf32_buffer", 247621236)
  StringName_method_store.to_wchar_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_wchar_buffer", 247621236)
  StringName_method_store.to_multibyte_char_buffer = GDW.Get_Builtin_Method(.STRING_NAME, "to_multibyte_char_buffer", 3055765187)
  StringName_method_store.hex_decode = GDW.Get_Builtin_Method(.STRING_NAME, "hex_decode", 247621236)
  StringName_method_store.hash = GDW.Get_Builtin_Method(.STRING_NAME, "hash", 3173160232)
