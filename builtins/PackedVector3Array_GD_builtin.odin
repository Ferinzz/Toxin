...
init_PackedVector3Array_Methods :: proc(PackedVector3Array_method_store: ^PackedVector3Array_Methods_list) {
  ...
  PackedVector3Array_method_store.get = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "get", 1394941017)
  PackedVector3Array_method_store.set = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "set", 3975343409)
  PackedVector3Array_method_store.size = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "size", 3173160232)
  PackedVector3Array_method_store.is_empty = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "is_empty", 3918633141)
  PackedVector3Array_method_store.push_back = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "push_back", 3295363524)
  PackedVector3Array_method_store.append = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "append", 3295363524)
  PackedVector3Array_method_store.append_array = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "append_array", 203538016)
  PackedVector3Array_method_store.remove_at = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "remove_at", 2823966027)
  PackedVector3Array_method_store.insert = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "insert", 3892262309)
  PackedVector3Array_method_store.fill = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "fill", 3726392409)
  PackedVector3Array_method_store.resize = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "resize", 848867239)
  PackedVector3Array_method_store.clear = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "clear", 3218959716)
  PackedVector3Array_method_store.has = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "has", 1749054343)
  PackedVector3Array_method_store.reverse = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "reverse", 3218959716)
  PackedVector3Array_method_store.slice = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "slice", 2086131305)
  PackedVector3Array_method_store.to_byte_array = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "to_byte_array", 247621236)
  PackedVector3Array_method_store.sort = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "sort", 3218959716)
  PackedVector3Array_method_store.bsearch = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "bsearch", 1259277637)
  PackedVector3Array_method_store.duplicate = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "duplicate", 4171207452)
  PackedVector3Array_method_store.find = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "find", 3718155780)
  PackedVector3Array_method_store.rfind = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "rfind", 3718155780)
  PackedVector3Array_method_store.count = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "count", 194580386)
  PackedVector3Array_method_store.erase = GDW.Get_Builtin_Method(.PACKED_VECTOR3_ARRAY, "erase", 3295363524)
